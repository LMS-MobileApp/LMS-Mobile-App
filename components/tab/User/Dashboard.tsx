  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.profileContainer}>
        <Image
          source={{ uri: 'https://media.istockphoto.com/id/2015429231/vector/vector-flat-illustration-in-black-color-avatar-user-profile-person-icon-profile-picture.jpg?s=612x612&w=0&k=20&c=Wu70OARg2npxWy5E22_ZLneabuTafvV_6avgYPhWOoU=' }} // Replace with actual profile image
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statBox}>
          <Text style={styles.statTitle}>Total Time Spend</Text>
          <Text style={styles.statValue}>1h 20m</Text>
        </View>
      </View>

      {/* Weekly Completed Assignments (Pie Chart) */}
      <Text style={styles.chartTitle}>Weekly Completed Assignments</Text>
      <View style={styles.chartContainer}>
        <ProgressChart
          data={{
            labels: ['Technology', 'Car Brands', 'Airlines', 'Energy'],
            data: [0.3, 0.5, 0.7, 0.8], // Percentage values
          }}
      ...
      {/* Optimize Study Time Button */}
      <TouchableOpacity style={styles.button}>
        <Text style={styles.buttonText}>Optimize Study Time</Text>
